...
/// <summary>
/// Model interface with Uuid property and IsLogicallyDeleted property and Timestamping (created / updated) support
/// </summary>
public class UuidAwareLogicallyDeletableTimeStampedModel : LogicallyDeletableTimeStampedModel, IUuidAwareModel
{
    ...
    public static bool operator ==(UuidAwareLogicallyDeletableTimeStampedModel left, UuidAwareLogicallyDeletableTimeStampedModel right)
    {
