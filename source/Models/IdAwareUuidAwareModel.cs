...
/// <summary>
/// Model interface with Id property and Uuid property
/// </summary>
public class IdAwareUuidAwareModel : UuidAwareModel, IIdAwareModel
{
    ...
    public static bool operator ==(IdAwareUuidAwareModel left, IIdAwareModel right)
    {
