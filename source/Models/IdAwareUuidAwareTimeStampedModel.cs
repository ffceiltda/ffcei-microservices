...
{
    public abstract class IdAwareUuidAwareTimeStampedModel : UuidAwareTimeStampedModel, IIdAwareModel
    {
        ...
        public static bool operator ==(IdAwareUuidAwareTimeStampedModel left, IdAwareUuidAwareTimeStampedModel right)
        {
