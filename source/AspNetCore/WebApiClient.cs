...
#pragma warning restore CA2007 // Consider calling ConfigureAwait on the awaited task
    ...
    protected async Task<RestResponse> ExecuteHTTPMethodAsyncWith(string httpApiPath, Method requestMethod,
        Action<RestRequest> configureHttpRequestDelegate)
    {
        using var httpClient = CreateRestClient();
        ...
        if (configureHttpRequestDelegate is not null)
        {
            configureHttpRequestDelegate(httpRequest);
        }
...
#pragma warning restore CA2007 // Consider calling ConfigureAwait on the awaited task
    ...
    protected async Task<(RestResponse, TOut?)> ExecuteHTTPMethodWithJsonResponseAsyncWith<TOut>(string httpApiPath, Method requestMethod, Action<RestRequest> configureHttpRequestDelegate)
        where TOut : class, new()
    {
#pragma warning disable CA2007 // Consider calling ConfigureAwait on the awaited task
        var httpResponse = await ExecuteHTTPMethodAsyncWith(httpApiPath, requestMethod, configureHttpRequestDelegate);
#pragma warning restore CA2007 // Consider calling ConfigureAwait on the awaited task
...
#pragma warning restore CA2007 // Consider calling ConfigureAwait on the awaited task
    ...
    protected async Task<RestResponse> ExecuteHTTPMethodWithBodyAsyncWith(string httpApiPath, Method requestMethod, DataFormat requestFormat, object requestBody,
        Action<RestRequest> configureHttpRequestDelegate)
    {
        using var httpClient = CreateRestClient();
...
#pragma warning restore CA2007 // Consider calling ConfigureAwait on the awaited task
    ...
    protected async Task<RestResponse> ExecuteHTTPMethodWithJsonBodyAsyncWith<TIn>(string httpApiPath, Method requestMethod,
        TIn jsonRequest, Action<RestRequest> configureHttpRequestDelegate) where TIn : class
    {
        using var httpClient = CreateRestClient();
...
#pragma warning restore CA2007 // Consider calling ConfigureAwait on the awaited task
    ...
    protected async Task<(RestResponse, TOut?)> ExecuteHTTPMethodWithJsonBodyAndResponseAsync<TIn, TOut>(string httpApiPath, Method requestMethod,
        TIn jsonRequest, Action<RestRequest> configureHttpRequestDelegate) where TIn : class where TOut : class, new()
    {
#pragma warning disable CA2007 // Consider calling ConfigureAwait on the awaited task
        var httpResponse = await ExecuteHTTPMethodWithJsonBodyAsyncWith<TIn>(httpApiPath, requestMethod, jsonRequest, configureHttpRequestDelegate);
#pragma warning restore CA2007 // Consider calling ConfigureAwait on the awaited task
