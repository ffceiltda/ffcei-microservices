...
/// </summary>
public abstract class MicroserviceBase : IMicroservice
{
    ...
    private static WeakReference<MicroserviceBase> _instance = null!;

    /// <summary>
    /// Default constructor
    /// </summary>
    /// <param name="commandLineArguments">Program command line arguments</param>
    protected MicroserviceBase(string[] commandLineArguments)
    {
        _instance = new WeakReference<MicroserviceBase>(this);
        ...
        IsDevelopment = string.Equals(System.Environment.GetEnvironmentVariable("ASPNETCORE_ENVIRONMENT") ??
...
#pragma warning disable CA1848 // Use the LoggerMessage delegates
        Logger.LogInformation("Microservice {MicroserviceName} starting at {DateTimeOffsetNow} (Debugging: {IsDebuggerAttached}, development mode: {IsDevelopment})",
            MicroserviceName, DateTimeOffset.Now, Debugger.IsAttached, IsDevelopment);
#pragma warning restore CA1848 // Use the LoggerMessage delegates
    ...
    public bool IsDebugOrDevelopment => Debugger.IsAttached || IsDevelopment;
...
#pragma warning disable CA1000
    /// <summary>
    /// Microservice base instance (singleton)
    /// </summary>
    public static MicroserviceBase? Instance
    {
        get
        {
